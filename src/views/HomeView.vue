...
<template>
  ...
  <div class="wrap">
    ...
    <div class="item">
      ...
      <img
        alt="problem3"
        src="@/assets/problem3.png"
        width="300px"
        height="200px"
      />
      <p>
        ファイルが1つしかない為<br />他の人が持って行ってしまうと<br />見ることができない
      </p>
    </div>
  </div>
  ...
  <div class="center">
    ...
    <div class="box3">
      <h4>
        他にも園での決まり事をまとめたページや献立表等も載せられます！<br />
...
.item {
  ...
  background-color: #fff;
  box-shadow: 0 6px 6px 0px rgba(57, 210, 146, 0.258);
  border-radius: 50px;
}
